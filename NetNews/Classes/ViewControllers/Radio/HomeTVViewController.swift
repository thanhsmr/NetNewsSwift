...
protocol HomeTVViewControllerDelegate {
    func btnDetailTouch(video: VideoObject)
}

class HomeTVViewController: ContentPageViewController, VideoTableViewCellDelegate {

    var tvCategory : TVCategory?
    var delegate: HomeTVViewControllerDelegate?
